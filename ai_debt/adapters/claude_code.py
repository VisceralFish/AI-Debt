...
def normalize_claude_code_payload(payload: dict[str, Any], raw_payload_ref: str) -> dict[str, Any]:
    ...
    if name in {"userpromptsubmit", "user_prompt_submit", "user_prompt_submitted"}:
        return {
            **base,
            "type": "user_prompt_submitted",
            "prompt_summary": summarize(first_value(payload, "prompt", "message", "user_prompt")),
        }
